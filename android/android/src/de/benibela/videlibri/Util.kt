...
fun showMessage(
        ...
        onNegativeButton: (DialogInstance.() -> Unit)? = null,
        onNeutralButton: (DialogInstance.() -> Unit)? = null,
        onPositiveButton: (DialogInstance.() -> Unit)? = null,
        more: Bundle? = null,
    ...
    val instance = DialogInstance(args, onNegativeButton, onNeutralButton, onPositiveButton)
...
data class DialogInstance (
    ...
    fun negativeButton(caption: String, onClicked: (DialogInstance.() -> Unit)?){
        args.putString("negativeButton", caption)
        onNegativeButton = onClicked
    }
    fun negativeButton(@StringRes caption: Int, onClicked: (DialogInstance.() -> Unit)?) =
        negativeButton(tr(caption), onClicked)


    fun neutralButton(caption: String, onClicked: (DialogInstance.() -> Unit)?){
        args.putString("neutralButton", caption)
        onNeutralButton = onClicked
    }
    fun neutralButton(@StringRes caption: Int, onClicked: (DialogInstance.() -> Unit)?) =
        neutralButton(tr(caption), onClicked)


    fun positiveButton(caption: String, onClicked: (DialogInstance.() -> Unit)?){
        args.putString("positiveButton", caption)
        onPositiveButton = onClicked
    }
    fun positiveButton(@StringRes caption: Int, onClicked: (DialogInstance.() -> Unit)?) =
