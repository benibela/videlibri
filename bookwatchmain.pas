...
type
  ...
  TmainForm = class(TVideLibriForm)
    ...
    procedure accountsChanged({%H-}Sender: TObject);
    procedure androidActivationTimerTimer({%H-}Sender: TObject);
    procedure bookPopupMenuPopup({%H-}Sender: TObject);
    procedure BookListUserSortItemsEvent({%H-}sender: TObject;
      var {%H-}sortColumn: longint; var {%H-}invertSorting: boolean);
    procedure cancelTheseBooksClick({%H-}Sender: TObject);
    procedure dailyCheckThreadTimer({%H-}Sender: TObject);
    procedure delayedCallTimer({%H-}Sender: TObject);
    procedure EnsureTrayIconTimerTimer(Sender: TObject);
    procedure extendAdjacentBooksClick({%H-}Sender: TObject);
    ...
    procedure BookListSelectItem({%H-}Sender: TObject; {%H-}Item: TTreeListItem);
    procedure FormShow({%H-}Sender: TObject);
    procedure FormWindowStateChange({%H-}Sender: TObject);
    procedure menuDuplicateCheckerClick({%H-}Sender: TObject);
    procedure MenuItem11Click({%H-}Sender: TObject);
    procedure MenuItemDebugLogClick({%H-}Sender: TObject);
    procedure MenuItemRenewClick({%H-}Sender: TObject);
    procedure MenuItem14Click({%H-}Sender: TObject);
    procedure MenuItem15Click({%H-}Sender: TObject);
    procedure MenuItem16Click({%H-}Sender: TObject);
    procedure MenuItem17Click({%H-}Sender: TObject);
    procedure MenuItem18Click({%H-}Sender: TObject);
    procedure MenuItem1Click({%H-}Sender: TObject);
    procedure MenuItem9Click(Sender: TObject);
    procedure MenuItemTesterClick({%H-}Sender: TObject);
    procedure MenuItem24Click({%H-}Sender: TObject);
    procedure MenuItem25Click({%H-}Sender: TObject);
    procedure MenuItem26Click({%H-}Sender: TObject);
    procedure MenuItem27Click({%H-}Sender: TObject);
    procedure MenuItem28Click({%H-}Sender: TObject);
    procedure MenuItem30Click({%H-}Sender: TObject);
    procedure MenuItem31Click({%H-}Sender: TObject);
    procedure menuXqueryClick({%H-}Sender: TObject);
    procedure newAccountWizardClosed({%H-}Sender: TObject; var CloseAction: TCloseAction);
    procedure removeSelectedMIClick({%H-}Sender: TObject);
    procedure displayDetailsMIClick(Sender: TObject);
    procedure repeatedCheckTimerTimer({%H-}Sender: TObject);
    procedure searchTextKeyDown({%H-}Sender: TObject; var {%H-}Key: Word;
      {%H-}Shift: TShiftState);
    procedure TrayIcon1Click({%H-}Sender: TObject);
    procedure TrayIcon1DblClick({%H-}Sender: TObject);
    procedure TrayIconClickTimer({%H-}Sender: TObject);
    procedure TreeListView1Click({%H-}Sender: TObject);
    procedure updateThreadConfigPartialUpdated({%H-}Sender: TObject);
    procedure UserExtendMenuClick(Sender: TObject);
    procedure MenuItem3Click({%H-}Sender: TObject);
    procedure MenuItem6Click({%H-}Sender: TObject);
    procedure MenuItem8Click({%H-}Sender: TObject);
    procedure searchCloseClick({%H-}Sender: TObject);
    procedure searchTextKeyUp({%H-}Sender: TObject; var {%H-}Key: Word; {%H-}Shift: TShiftState
      );
    procedure searchUpClick({%H-}Sender: TObject);
    ...
    procedure ShowOptionsClick({%H-}Sender: TObject);
    procedure btnRefreshClick({%H-}Sender: TObject);
    procedure ToolButton2ContextPopup({%H-}Sender: TObject; {%H-}MousePos: TPoint;
      var Handled: Boolean);
    procedure ToolButton3Click({%H-}Sender: TObject);
  ...
  public
    ...
    procedure BookListDblClick({%H-}Sender: TObject);
    procedure BookListEditingDone({%H-}Sender: TObject);
    procedure BookListMouseDown({%H-}Sender: TObject; {%H-}Button: TMouseButton; Shift: TShiftState; X, {%H-}Y: Integer);
